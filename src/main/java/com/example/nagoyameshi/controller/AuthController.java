...
public class AuthController {
	...
	{	
		if (signupForm.getPassword() != null && signupForm.getPasswordConfirmation() != null
				&& !signupForm.getPassword().equals(signupForm.getPasswordConfirmation())) {
			bindingResult.rejectValue("passwordConfirmation", "error.signupForm", "パスワードが一致しません");
		}
